...
public class WebFrontUserFinantial extends WebFrontAlpha {
    //=======================================================================
    public static final String PAGE = "/finantial/user/home";
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) {
        ...
        try{
            ...
            BalanceInfo balance = flowbeta.getAurigaObject().getBillingLambda().getTotalBalance(userid);
            back.setUser(user);
            back.setBalance(balance);
