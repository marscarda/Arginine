...
//***************************************************************************
@WebServlet(name = "ApiBillCommerce", urlPatterns = {ApiBillCommerce.URL}, loadOnStartup=1)
public class ApiBillCommerce extends ApiAlpha {
    public static final String URL = "/finantial/billcommercetransfers";
   //************************************************************************
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            exec.billCommerceTransfers(session.getUserId());
            //-------------------------------------------------------
            JsonObject jsonresp = new JsonObject();
            jsonresp.addPair(new JsonPair(RESULT, RESULTOK));
            jsonresp.addPair(new JsonPair(RESULTDESCRIPTION, "Commerce Transfers Billing Started"));
            //-------------------------------------------------------
            ...
            System.out.println("Failed to bill commerce transfers");
