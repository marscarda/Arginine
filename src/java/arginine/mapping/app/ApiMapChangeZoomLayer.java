...
//***************************************************************************
@WebServlet(name = "ApiMapChangeZoom", urlPatterns = {ApiMapChangeZoomLayer.URL}, loadOnStartup=1)
public class ApiMapChangeZoomLayer extends ApiAlpha {
    public static final String URL = "/mapping/app/newzoomlayer";
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try { scalefactor = Float.parseFloat(req.getParameter(SCALEFACTOR)); } catch (Exception e) {}
        try {
            //-----------------------------------------------------
            ...
            view.initialize();
            view.changeZoom(scalefactor, eventx, eventy);
            view.initialize();
            view.makeDraw();
            //-----------------------------------------------------
